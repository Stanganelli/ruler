...
if (ruler == "roman") {
    moneytim = "denarius"
    var img = `<img src="augusuts.jpg" alt="">`

}
if (ruler == "greek") {
    moneytim = "drachmas"
    var img = `<img src="alexander.jpg" alt="">`
    var som = `<audio src="greek.mp3" autoplay loop></audio>`
}
if (ruler == "franc") {
    moneytim = "centimes"
    var img = `<img src="napoleao.jpg" alt="">`
    var som = `<audio src="french.mp3" autoplay loop></audio>`
}
if (ruler == "otoman") {
    moneytim = "liras"
    var img = `<img src="mehemed.jpg" alt="">`
    var som = `<audio src="turk.mp3" autoplay loop></audio>`
}
if (ruler == "perisan") {
    moneytim = "dìngs"
    var img = `<img src="qin.jpg" alt="">`
    var som = `<audio src="china.mp3" autoplay loop></audio>`
}
